...
# Crystal implementation of ChaCha12 PRNG.
...
class Random::ChaCha12
  ...
  private def init_buffer(key : StaticArray(UInt32, 8))
    ...
    # the rest is counter that will be filled in chacha12
  end
